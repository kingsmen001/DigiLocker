<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="DigiLocker3.Index" %>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default-top navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a style="color:white" class="navbar-brand" href="index.aspx?id=<%=Server.UrlDecode(Request.QueryString["id"]) %>">Digilocker</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="index.aspx?id=<%=Server.UrlDecode(Request.QueryString["id"]) %>"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                        </li>
                        <%--<li>
                        ...
                        <li>
                            <a href="download.aspx?id=<%=Server.UrlDecode(Request.QueryString["id"]) %>"><i class="fa fa-table fa-fw"></i> Download</a>
                        </li>
                        <li>

                            <a href="upload.aspx?id=<%=Server.UrlDecode(Request.QueryString["id"]) %>"><i class="fa fa-edit fa-fw"></i> Upload</a>
                        </li>
                        <li>

                            <a href="NewCourse.aspx?id=<%=Server.UrlDecode(Request.QueryString["id"]) %>"><i class="fa fa-edit fa-fw"></i> Add Course</a>
                        </li>
                        <li>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-primary">
                        ...
                        <a href="uploaded.aspx?id=<%=Server.UrlDecode(Request.QueryString["id"]) %>">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-green">
                        ...
                        <a href="issued.aspx?id=<%=Server.UrlDecode(Request.QueryString["id"]) %>">
                            <div class="panel-footer">
                                <span class="pull-left">View Details</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
