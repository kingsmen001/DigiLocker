<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateMarksOfficers.aspx.cs" Inherits="DigiLocker3.UpdateMarksOfficers" %>
    ...
    <div id="wrapper">
        <form id="form1" runat="server">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Update Marks and Seniority-Officers</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                                ...
                                <div class="row" style="width: 100%">
                                    ...
                                    <div class="col-lg-6" style="width: 100%">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-2" id="div1" runat="server" visible="false">
                                                <label>Maximum Seniorrity </label>
                                                <asp:TextBox CssClass="form-control" runat="server" ID="senTextBox" Enabled="false"></asp:TextBox>
                                            </div>
