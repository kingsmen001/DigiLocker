<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SeniorityDetailsOfficers.aspx.cs" Inherits="DigiLocker3.SeniorityDetailsOfficers" %>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" id="heading" runat="server">Add Seniority Details-Officers</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
