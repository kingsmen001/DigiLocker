<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadNominalRollOfficers.aspx.cs" Inherits="DigiLocker3.UploadNominalRollOfficers" %>
...
<body>
    ...
    <div id="wrapper">
            ...
            <ul class="nav navbar-top-links navbar-right" style="margin-top: 7px; margin-right: 15px">
                ...
                <%--<li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>--%>
                <li><asp:Button runat="server" CssClass="btn btn-primary" ID="Button1" Text="Logout" OnClick="LogoutButton_Click"/>
                </li>
                <%--</ul>--%>
                <!-- /.dropdown-user -->
                <%--</li>--%>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" id="heading" runat="server">Add Trainees-Officers</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
