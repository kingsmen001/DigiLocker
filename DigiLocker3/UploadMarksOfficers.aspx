<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadMarksOfficers.aspx.cs" Inherits="DigiLocker3.UploadMarksOfficers" %>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" runat="server" id="heading">Upload Marks-Officers</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
